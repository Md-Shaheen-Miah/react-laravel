 ...
 const Gynecology = () => {
  ...
  <div className="about-container">
    <div className="doctor-info">
      <img src="img/raju.png" alt="" className="doctor-photo" />
      <h1>Dr. Raju Molla</h1>
      <h3>Specialist in Gynecology</h3>
    </div>
    
    <div className="doctor-description">
      <h2>About Dr. Raju Molla</h2>
      <p>
        Dr. Raju is a highly experienced and compassionate medical professional
