      ...
      <div className="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <div className="nav-item dropdown">
          ...
          <div className="dropdown-menu rounded-0 rounded-bottom m-0">
            <NavLink className="dropdown-item" to="">Feature</NavLink>
            <NavLink className="dropdown-item" to="">Our Doctor</NavLink>
            <NavLink className="dropdown-item" to="">Appointment</NavLink>
            <NavLink className="dropdown-item" to="">Testimonial</NavLink>
